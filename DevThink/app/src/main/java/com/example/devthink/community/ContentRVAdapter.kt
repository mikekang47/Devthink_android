...
class ContentRVAdapter(private val contentList: ArrayList<Content>) : RecyclerView.Adapter<ContentRVAdapter.ViewHolder>() {

    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ContentRVAdapter.ViewHolder {
