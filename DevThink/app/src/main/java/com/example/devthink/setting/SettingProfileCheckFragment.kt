...
class SettingProfileCheckFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.settingCheckOkBtn.setOnClickListener {
            navController.navigate(R.id.action_settingProfileCheckFragment_to_SettingPersonalInfoFragment)
        }
        binding.settingCheckExitIv.setOnClickListener {
            navController.navigate(R.id.action_settingProfileCheckFragment_to_SettingFragment)
        }
    }
}